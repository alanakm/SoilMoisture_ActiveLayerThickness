...
The RunModelScripts folder contains the automated scripts used to run soilice. Soil parameters and boundary condiitons are set within this function. 

The model outputs presented in the manuscript are available in ModelOutputs for all simulations, provided in .dill format. 

The decription of the soilice model can be found in the GitHub repository here: https://github.com/amireson/soilice
